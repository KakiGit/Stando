...
impl App {
    ...
    pub async fn selected_history_chat_id(
        history_panel_state: Arc<RwLock<HistoryPanelState>>,
    ) -> Option<String> {
        let _log_guard = logging::function_guard("App::selected_history_chat_id");
        let guard = history_panel_state.read().await;
    ...
    pub fn normalized_ai_query(query: &str) -> Option<String> {
        let _log_guard = logging::function_guard("App::normalized_ai_query");
